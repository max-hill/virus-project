...
get_networks("set1b","experiment-21-with-major-breakpoint-only",21)
get_networks("set1c","experiment-21-with-major-breakpoint-only",21)
...
# we run the following, which gives the code for the networks listed below
get_networks("set1b","experiment-23-with-no-breakpoints",23)
get_networks("set1c","experiment-23-with-no-breakpoints",23)
